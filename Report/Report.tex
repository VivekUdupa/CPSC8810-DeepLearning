...
\section{Results}
The network described in section \ref{model_train} was trained using 2494 images split into 10 categories. For a batch size of 1, 15 epochs and a learning rate of 0.0001, the following results were observed. \\
