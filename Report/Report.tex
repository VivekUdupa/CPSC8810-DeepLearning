...
\begin{enumerate}
	\item \textbf{Image Pre-Processing: } The given input image is converted into mono-channeled, grayscale image of size 256 x 256. Then it is converted to a PyTorch tensor image and itsd values are normalized with a mean of 0.5 and Standard Deviation of 0.5.   
...
\begin{enumerate}
	...
	\item Perform backpropagation to minimize the loss
